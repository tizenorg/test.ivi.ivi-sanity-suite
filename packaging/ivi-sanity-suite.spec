...
%install
install -d %{buildroot}/%{_datadir}/tests/ivi/%{name}
install -m 0755 runtest.sh %{buildroot}/%{_datadir}/tests/ivi/%{name}
install -m 0755 process_check/prs_checker %{buildroot}/%{_datadir}/tests/ivi/%{name}
install -m 0644 process_check/testkit.xml %{buildroot}/%{_datadir}/tests/ivi/%{name}
install -m 0644 LICENSE %{buildroot}/%{_datadir}/tests/ivi/%{name}
install -m 0644 process_check/README %{buildroot}/%{_datadir}/tests/ivi/%{name}
...
%defattr(-,root,root)
%{_datadir}/tests/ivi/%{name}/runtest.sh
